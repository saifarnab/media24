...
<head>
  ...
  <link href="css/details_style.css" rel="stylesheet"S>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 order-lg-1 order-2">
					<ul class="image_list">
						<li data-image="images/single_4.jpg"><img src="img/b1.jpeg" alt=""></li>
						<li data-image="images/single_2.jpg"><img src="img/b2.jpeg" alt=""></li>
						<li data-image="images/single_3.jpg"><img src="img/b3.jpg" alt=""></li>
					</ul>
				</div>

				<!-- Selected Image -->
				<div class="col-lg-5 order-lg-2 order-1">
					<div class="image_selected"><img src="img/b3.jpg" alt=""></div>
				</div>

				<!-- Description -->
				<div class="col-lg-5 order-3">
					<div class="product_description">
						<div class="product_category"><b>BillBoard</b></div>
						<div class="product_name">Shimanto Square Roof Top</div>
						<div class="product_text"><p>An excellent location to promote your busniess or ideas by billboard advertising.Billboards are ideal for delivering great impact to your message and can be bought individually or in flexible packs in demographic areas, key addresses can be selected.</p></div>
						<div>
							<form action="#">
								<div class="product_price">Price: 115 taka per day</div>
