 ...
 <!--==========================
  ...
  <section id="hero">
    <div class="hero-container">
      <h1>Airport advertising experts</h1>
...
<main id="main">
    ...
    <section id="portfolio">
        ...
        <div class="row">
          <div class="col-md-12">
            <ul id="portfolio-flters">
              <li data-filter=".filter-dhanmondi, .filter-shahbug, .filter-mirpur, .filter-newmarket" class="filter-active">All</li>
              <li data-filter=".filter-shah">Shahjalal Airport</li>
              <li data-filter=".filter-chi">Chittagong Airport</li>
              <li data-filter=".filter-shy">Shylet Airport</li>
              <li data-filter=".filter-ran">Rangpur Airport</li>
            </ul>
          </div>
        </div>
        
        <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-shah">
     ...
     <div class="row" id="portfolio-wrapper">
      ...
      <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-ran">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
