...
<main id="main">
    ...
    <section id="portfolio">
        ...
        <div class="row">
          <div class="col-md-12">
            <ul id="portfolio-flters">
              <li data-filter=".filter-khul, .filter-raj, .filter-noa, .filter-chi" class="filter-active">All</li>
              <li data-filter=".filter-khul">Dhaka to Khulna</li>
              <li data-filter=".filter-raj">Dhaka to Rajshahi</li>
              <li data-filter=".filter-chi">Dhaka to Chittagong</li>
              <li data-filter=".filter-noa">Dhaka to Noakhali</li>
            </ul>
          </div>
        </div>
        
        <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-raj">
      ...
      <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-khul">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
      ...
      <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-chi">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
      ...
      <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-noa">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
