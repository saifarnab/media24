    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#portfolio">Choose A Cinema Hall</a></li>
 ...
 <!--==========================
  ...
  <section id="hero">
    <div class="hero-container">
      <h1>Cinema Hall advertising experts</h1>
...
<main id="main">
    ...
    <section id="portfolio">
      <div class="container wow fadeInUp">
        <div class="section-header">
          <h3 class="section-title">Select A Cinema Hall</h3>
          <p class="section-description">Have a look to some of our amazing offers.</p>
        </div>
        <div class="row">
          <div class="col-md-12">
            <ul id="portfolio-flters">
              <li data-filter=".filter-block, .filter-star, .filter-shy, .filter-bola" class="filter-active">All</li>
              <li data-filter=".filter-star">Star Sineplex</li>
              <li data-filter=".filter-block">Blockblaster</li>
              <li data-filter=".filter-shy">Shymoli</li>
              <li data-filter=".filter-bola">Bolaka</li>
            </ul>
          </div>
        </div>
        
        <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-star">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
                  <th>Hall # of Star Sineplex</th>
                  <th>Price (for a single show)</th>
                  <th>Order</th>
      ...
      <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-block">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
                  <th>Hall # of Star Blockblaster</th>
                  <th>Price (for a single show)</th>
                  <th>Order</th>
    ...
    <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-shy">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
                  <th>Hall # of Star Shamoli</th>
                  <th>Price (for a single show)</th>
                  <th>Order</th>
     ...
     <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-bola">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
                  <th>Hall # of Bolaka</th>
                  <th>Price (for a single show)</th>
                  <th>Order</th>
