...
<div class="modal fade" id="elegantModalForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <main id="main">
    ...
    <section id="portfolio">
      <div class="container wow fadeInUp col-md-12">
        <div class="section-header">
          <h3 class="section-title">Ordering Cart</h3>
        </div>
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th>Price per day/tour</th>
                  <th>Day/Tour Count</th>
                  <th>Total Amount</th>
                ...
                <tbody>
                  <tr>
                    <td>Dhanmondi</td>
                    <td>BillBoard</td>
                    <td><a href="#">Shimanto Square Roof Top</a></td>
                    <td>215/=</td>
                    <td>2</td>
                    <td>430/=</td>
      ...
      <h3 class="total">Grand Total: 1290 taka</h3>
      <a><button type="button" class="btn btn-success total">Pay</button></a>
    </section>
