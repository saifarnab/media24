  ...
  <header id="header">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="/media24/index.php">Home</a></li>
          <li><a href="#portfolio">Choose Station</a></li>
 ...
 <!--==========================
  ...
  <section id="hero">
    <div class="hero-container">
      <h1>Rail advertising experts</h1>
    ...
    <section id="portfolio">
      <div class="container wow fadeInUp">
        <div class="section-header">
          <h3 class="section-title">Select A Station</h3>
          <p class="section-description">Have a look to some of our amazing offers.</p>
        </div>
        <div class="row">
          <div class="col-md-12">
            <ul id="portfolio-flters">
              <li data-filter=".filter-komola, .filter-air, .filter-kaw, .filter-ton" class="filter-active">All</li>
              <li data-filter=".filter-komola">Komolapur Station</li>
              <li data-filter=".filter-air">Airport Rail Station</li>
              <li data-filter=".filter-kaw">Kawran Bazar Station</li>
              <li data-filter=".filter-ton">Tongi Station</li>
            </ul>
          </div>
        </div>
        
        <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-komola">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
                  <th>Position in Komolapur Station</th>
                  <th>Price (per day)</th>
                  <th>Order</th>
                ...
                <tbody>
                  <tr>
                    <td>Available</td>
                    <td><a href="/media24/details.php">Termial 1</a></td>
                    <td>215/=</td>
                    <td><a href="/media24/cart.php">add to cart</a></td>
      ...
      <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-air">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
                  <th>Position in Airport Station</th>
                  <th>Price (per day)</th>
                  <th>Order</th>
     ...
     <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-ton">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
                  <th>Position in Tongi Station</th>
                  <th>Price (per day)</th>
                  <th>Order</th>
      ...
      <div class="row" id="portfolio-wrapper">
          <div class="col-md-12 portfolio-item filter-kaw">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Availability</th>
                  <th>Position in Kawran Bazar Station</th>
                  <th>Price (per day)</th>
                  <th>Order</th>
